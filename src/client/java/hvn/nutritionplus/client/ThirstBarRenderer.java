...
public class ThirstBarRenderer {
	...
	private static final ResourceLocation THIRST_TEXTURE = ResourceLocation.withDefaultNamespace("textures/gui/thirst_icon.png");
	
	private static final Minecraft minecraft = Minecraft.getInstance();
	
	// Icon dimensions (similar to heart size)
	private static final int ICON_SIZE = 16; // 16x16 pixels
